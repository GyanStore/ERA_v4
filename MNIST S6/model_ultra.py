...
class Model_1(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(12, 18, kernel_size=3, padding=1)
        self.bn3 = nn.BatchNorm2d(18)
        
        # Block 4: Deeper features
        self.conv4 = nn.Conv2d(18, 24, kernel_size=3, padding=1)
        self.bn4 = nn.BatchNorm2d(24)
        
        # Block 5: Final features
        self.conv5 = nn.Conv2d(24, 10, kernel_size=3, padding=1)
    ...
    def forward(self, x):
        # Block 1: 1×28×28 → 6×28×28
        x = F.relu(self.bn1(self.conv1(x)))
        x = self.dropout1(x)
        
        # Block 2: 6×28×28 → 12×28×28
        x = F.relu(self.bn2(self.conv2(x)))
        x = F.max_pool2d(x, 2)  # 12×14×14
        
        # Block 3: 12×14×14 → 18×14×14
        x = F.relu(self.bn3(self.conv3(x)))
        x = self.dropout2(x)
        
        # Block 4: 18×14×14 → 24×14×14
        x = F.relu(self.bn4(self.conv4(x)))
        x = F.max_pool2d(x, 2)  # 24×7×7
        
        # Block 5: 24×7×7 → 10×7×7
        x = self.conv5(x)
...
class Model_3(nn.Module):
    ...
    def __init__(self):
        ...
        self.bn4 = nn.BatchNorm2d(32)
        self.conv4_res = nn.Conv2d(24, 32, kernel_size=1)  # Residual connection
    ...
    def forward(self, x):
        ...
        # Block 2: 8×28×28 → 16×28×28 with residual
        ...
        # Block 4: 24×14×14 → 32×14×14 with residual
