...
Model_1: Ultra-efficient CNN with strategic design
Model_2: Depthwise separable convolutions (already optimized)
...
class Model_2(nn.Module):
    """
    Model_2: Depthwise Separable Convolutions (Keep existing optimized version)
