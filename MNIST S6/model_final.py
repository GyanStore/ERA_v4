"""
MNIST S6 Assignment - Ultra-Efficient Models Final
==================================================
...
class Model_2(nn.Module):
    ...
    def __init__(self):
        ...
        self.depthwise1 = nn.Conv2d(12, 12, kernel_size=3, padding=1, groups=12)
        self.pointwise1 = nn.Conv2d(12, 20, kernel_size=1)
        ...
        self.depthwise2 = nn.Conv2d(28, 28, kernel_size=3, padding=1, groups=28)
        self.pointwise2 = nn.Conv2d(28, 36, kernel_size=1)
    ...
    def forward(self, x):
        ...
        # Block 2: Depthwise separable 12×28×28 → 20×28×28
        ...
        # Block 4: Depthwise separable 28×14×14 → 36×14×14
...
class Model_3(nn.Module):
    ...
    Target: <8000 parameters, 99.4% accuracy consistently, ≤15 epochs
    Strategy: Residual connections, optimal design
    ...
    def __init__(self):
        ...
        self.bn2 = nn.BatchNorm2d(20)
        self.conv2_res = nn.Conv2d(12, 20, kernel_size=1)  # Residual connection
        ...
        self.bn4 = nn.BatchNorm2d(36)
        self.conv4_res = nn.Conv2d(28, 36, kernel_size=1)  # Residual connection
    ...
    def forward(self, x):
        ...
        # Block 2: 12×28×28 → 20×28×28 with residual
        ...
        # Block 4: 28×14×14 → 36×14×14 with residual
